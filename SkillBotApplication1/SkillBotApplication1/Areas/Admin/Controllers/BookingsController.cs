...
namespace SkillBotApplication1.Areas.Admin.Controllers
{
    ...
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,NumPeople,PhNum,Requests,BookingDateTime")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,NumPeople,PhNum,Requests,BookingDateTime")] Booking booking)
        {
            if (ModelState.IsValid)
            {
